                        ...
                        <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4 flex items-center space-x-2">
                                ...
                                <a href="javascript:void(0);">
                                    <button title="Approve this Manuscript" data-id="{{ $manuscript->id }}" class="approve-button px-3 py-2 bg-blue-500 text-white rounded hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-green-500">
