...
<main class="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
	<h1 class="text-9xl font-extrabold text-white tracking-widest">419</h1>
	<div class="bg-[#1b651b] px-2 text-sm rounded rotate-12 absolute">
		Page Expired
	</div>
	<button class="mt-5">
      <a  href="/"
        class="relative inline-block text-sm font-medium text-[#1b651b] group active:text-orange-500 focus:outline-none focus:ring"
      >
        <span
