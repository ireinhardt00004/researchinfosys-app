<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 w-full">
                    <h5 class="text-2xl font-bold text-center mb-4">Utilized Research</h5>
                    <form id="recordForm" action="{{ route('utilized.store') }}" method="POST" class="space-y-6">
                        @csrf
    ...
    <script>
        ...
        tableData.push({
            ...
            title_research_project: manuscript.title || '',
            project_leader_staff: manuscript.project_leader || '',
            campus_college: manuscript.campus_college || '',
            date_started: formattedDateStarted,
            date_completed: formattedDateCompleted,
            ifnt_cvsu_research_type: manuscript.research_type || '',
            beneficiary_industry: manuscript.beneficiary_industry || '',
            product_name_method: manuscript.product_name_method || '',
            brief_desc: manuscript.brief_desc || '',
            patent_utility: manuscript.patent_utility || '',
            initial_date_utilization: manuscript.initial_date_utilization || '',
            development: manuscript.development || '',
            service: manuscript.service || '',
            utilization_others: manuscript.utilization_others || '',
        });
    });
            table = new Tabulator("#table-container", {
                ...
                columns: [
                    ...
                    { title: "Beneficiary/Industry", field: 'beneficiary_industry', editor: "input" },
                    { title: "Product Name/Method", field: 'product_name_method', editor: "input" },
                    { title: "Brief Description", field: 'brief_desc', editor: "input" },
                    { title: "Patent/Utility Model", field: 'patent_utility', editor: "input" },
                    { title: "Initial Date of Utilization", field: 'initial_date_utilization', editor: "input" },
                    { title: "Development", field: 'development', editor: "input" },
                    { title: "Service", field: 'service', editor: "input" },
                    { title: "Other Utilizations", field: 'utilization_others', editor: "input" },
                ],
            });
        }
    ...
    @section('title', 'Utilized Research')
</x-app-layout>
