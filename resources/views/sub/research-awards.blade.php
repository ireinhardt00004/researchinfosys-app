        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 w-full">
                    <h5 class="text-2xl font-bold text-center mb-4">Research Awards</h5>
                    <form id="recordForm" action="{{ route('research-award.store') }}" method="POST" class="space-y-6">
                        @csrf
        ...
        tableData.push({
            ...
            table = new Tabulator("#table-container", {
                ...
                columns: [
                    ...
                    { title: "Campus/College/RDE Unit", field: 'campus_college', editor: "input" },
                    { title: "Date Started", field: 'date_started', editor: "input" },
                    { title: "Date Completed", field: 'date_completed', editor: "input" },
                    { title: "Research Title Award", field: 'research_title_award', editor: "input" },
                    { title: "Research Title Output", field: 'researcg_title_output', editor: "input" },
                    { title: "Researcher Award", field: 'researcher_award', editor: "input" },
                    { title: "Date Awarded (Researcher)", field: 'date_awarded_researcher', editor: "input" },
                    { title: "Venue", field: 'venue', editor: "input" },
                    { title: "Awarding Body", field: 'awarding_body', editor: "input" },
                    { title: "Title of Conference/Symposium", field: 'title_conference_symposium', editor: "input" },
                    { title: "Level (International/National/Regional/Local)", field: 'level', editor: "input" },
                ],
            });
        }
