        ...
        <header class="w-full p-1 bg-white flex justify-start items-center shadow-md z-10">
            ...
            <section class="p-2 flex items-center space-x-5 sm:ms-10 me-auto">
               <a href="/"> <img src="{{ asset('sys_logo/RISlogo1.svg')}}" class="object-contain sm:h-16 sm:w-16 w-9 h-9 drop-shadow-xl" alt=""></a>
                <a href="/"><h1 class="sm:text-xl text-md font-bold text-nowrap  text-slate-800">Research InfoSys</h1></a>
            </section>
            ...
            <nav class="sm:hidden ms-auto">
                ...
                <section >
                    ...
                    {{--  <ul class="flex space-x-3 text-md ">
                        <li class="hover:bg-[#1B651B] py-2 px-3 hover:text-white rounded-md transition-all">Home</li>
                        @guest
                        <li class="hover:bg-[#1B651B] py-2 px-3 hover:text-white rounded-md transition-all"><a href="{{ route('login') }}">Login</a></li>
                        <li class="hover:bg-[#1B651B] py-2 px-3 hover:text-white rounded-md transition-all"><a href="{{ route('register') }}"></a>Sign up</li>
                        @endguest
                        <li class="hover:bg-[#1B651B] py-2 px-3 hover:text-white rounded-md transition-all">Contact</li>
                        @auth
                        <li class="hover:bg-[#1B651B] py-2 px-3 hover:text-white rounded-md transition-all">Dashboard</li>
                        @endauth
                    </ul>--}}
            </nav>
        </header>
         <main class="h-screen w-full grid grid-cols-1 place-items-center justify-center items-center overflow-y-auto">
            <div class="h-screen flex flex-col items-center w-full relative overflow-hidden">
             <img src="{{asset('img/layered-peaks-haikei.svg')}}" alt="" class="absolute w-full h-full object-cover rounded-lg drop-shadow-lg z-0">
            <div class="h-full w-[100%] bg-transparent sm:rounded-lg z-10 flex flex-col justify-start items-center ">
                <div class="mt-2">
                    <a href="/">  
                        <x-application-logo class="sm:w-20 sm:h-20 fill-current text-gray-500" />
                    </a>
                </div>
